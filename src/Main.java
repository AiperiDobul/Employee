...
//        В жизни важны всего три вещи. Они движут и тобой, и любой живой тварью:
//        первая – выживание, вторая – общественный уклад, третья – удовольствие.
//                Все в жизни проходит через эти три этапа. Причем после удовольствия уже ничего нет,
//        Отсюда вывод: смысл жизни – достичь третьего этапа. Достиг его – и дело в шляпе.
//        Но сперва – пройди два предыдущих ... Самый очевидный пример – секс.
//                Исходно он служил выживанию, потом стал частью общественного уклада: отсюда брак.
//        А потом он переходит в разряд развлечений.
